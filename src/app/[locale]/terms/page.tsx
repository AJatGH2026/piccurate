...
function GermanBody({ withdrawalUrl }: { withdrawalUrl: string }) {
  return (
    <>
      ...
      <p>Die Bestätigung des Vertrags stellen wir dir in Textform auf einem dauerhaften Datenträger bereit: Wir zeigen sie dir unmittelbar bei Vertragsschluss im Ablauf an und bieten sie dort zum Speichern an. Ist zu deinem Konto eine E-Mail-Adresse hinterlegt oder hinterlegst du sie später, senden wir dir denselben Text zusätzlich per E-Mail; in kostenpflichtigen Tarifen außerdem die Rechnung.</p>
      ...
      <Statutory>
        ...
        {/* Verbatim from the Muster, delivery-costs parenthesis included. It was
            dropped here as meaningless for a digital service — but none of the
            Gestaltungshinweise permits omitting it, and any deviation costs the
            Gesetzlichkeitsfiktion the Muster exists to provide. Keeping it is
            harmless: it can only promise the consumer more than we could ever
            owe, since there are no delivery costs to reimburse. */}
      ...
      <p>Optional kannst du dir bekannte Personen anhand eines Referenzfotos in deinen ausgewählten privaten Fotos wiederfinden lassen. Die Personensuche läuft vollständig auf deinem Endgerät; Referenzfoto, daraus abgeleitete Gesichtsmerkmale und das Ergebnis werden zu keinem Zeitpunkt an uns übermittelt. Die Funktion ist ausschließlich für persönliche oder familiäre Zwecke bestimmt. Du musst zur Verwendung jedes Referenzfotos berechtigt sein und bestätigst dies vor der Verwendung.</p>
      <p>Die Personensuche ist Bestandteil der kostenpflichtigen Tarife. Wir können sie zeitweise — etwa während der Erprobungsphase — oder dauerhaft auch im kostenlosen Tarif anbieten. Ein Anspruch auf künftige kostenlose Bereitstellung entsteht daraus nicht.</p>
      ...
      <p>Du versicherst, dass du die Fotos ausschließlich für persönliche oder familiäre Zwecke auswählst und übermittelst und dass die Nutzung keine Urheber-, Persönlichkeits- oder sonstigen Rechte Dritter verletzt. Soweit auf einem Referenzfoto eine andere Person abgebildet ist, musst du zur Verwendung dieses Fotos im privaten, persönlichen oder familiären Bereich berechtigt sein; Einzelheiten zur rein lokalen Verarbeitung der Personensuche stehen in Abschnitt 9.1a.</p>
      <p>Für sämtliche Referenzfotos eines Analysevorgangs genügt eine einzige, nicht vorausgewählte Bestätigung im Referenzfoto-Uploadfeld. Du musst weder für jede Person ein separates Kästchen markieren noch einen schriftlichen Nachweis beschaffen oder hochladen. Diese Bestätigung ist eine vertragliche Zusicherung; sie wird nicht an uns übermittelt oder von uns gespeichert. AuswahlBuddy darf auf ihre Richtigkeit vertrauen, soweit keine konkreten Anhaltspunkte für Missbrauch oder eine fehlende Berechtigung bestehen.</p>
      <p>Die Personensuche darf nicht verwendet werden, wenn du weißt oder erkennen musst, dass die betroffene Person widerspricht oder du zur Verwendung nicht berechtigt bist. Eine einmal erklärte Ablehnung ist bei künftigen Analysevorgängen zu beachten.</p>
      <h2>8. Unzulässige Nutzung</h2>
      <p>Untersagt sind insbesondere: rechtswidrige Inhalte; Schadsoftware; automatisierte Massenabfragen; Umgehung technischer Schutzmaßnahmen; Angriffe auf den Dienst; berufliche, gewerbliche oder institutionelle Nutzung der Personensuche — etwa gegenüber Arbeitgebern, Arbeitnehmern, Kunden oder Veranstaltungsteilnehmern; biometrischer Abgleich ohne die erforderliche Berechtigung; Identifizierung unbekannter Personen; Suche in öffentlichen oder fremden Bildbeständen; Überwachung, Nachverfolgung, Strafverfolgungs- oder Sicherheitszwecke; Aufbau von Gesichts- oder Personendatenbanken; kommerzielle Personenprofile; biometrische Kategorisierung oder Emotionserkennung; sowie jede Nutzung, die Rechte Dritter oder die Bedingungen unserer technischen Anbieter verletzt.</p>
      ...
      <h2>9. Datenschutz</h2>
      <p>Informationen zur Verarbeitung personenbezogener Daten und zur möglichen Google-Aufbewahrung bis zu 55 Tagen bei der allgemeinen Fotoanalyse enthält die Datenschutzerklärung. Für die ausgewählten Fotoinhalte verarbeitet AJ GmbH ausschließlich auf deine Weisung; für eigene Website-, Sicherheits-, Support- und Vertragsdaten ist AJ GmbH Verantwortlicher. Referenzfotos und die daraus abgeleiteten Gesichtsmerkmale für die Personensuche erhält AJ GmbH nicht — Einzelheiten in Abschnitt 9.1a und in der Datenschutzerklärung.</p>
      <p>Die nachstehenden Auftragsverarbeitungsbedingungen gelten, soweit AJ GmbH Fotoinhalte in deinem Auftrag verarbeitet.</p>
      ...
      <p>9.1 Ergänzende Bedingungen zur Verarbeitung von Fotoinhalten</p>
      <p>Gegenstand und Dauer: Verarbeitet werden die von dir für einen konkreten Vorgang ausgewählten Vorschaubilder, erforderliche Metadaten und Analyseergebnisse. Die Verarbeitung beginnt mit dem Start des Vorgangs und endet nach Abschluss der Analyse und der technisch unvermeidbaren Kurzzeitspeicherung; abweichende Google-Aufbewahrungen sind in der Datenschutzerklärung beschrieben.</p>
      <p>Art und Zweck: Verkleinerung, Übermittlung und automatisierte Qualitäts- und Motivanalyse.</p>
      <p>Daten und betroffene Personen: Bildinhalte, Aufnahmemetadaten und technische Vorgangsdaten von Nutzern sowie von Familienangehörigen, Freunden und sonstigen Personen, die auf den ausgewählten privaten Fotos abgebildet sind.</p>
      <p>Weisungen und Pflichten des Nutzers: Du erteilst die dokumentierte Weisung durch Auswahl der Fotos, Festlegung der Kriterien und Start der Analyse. Du darfst keine rechtswidrigen Weisungen erteilen.</p>
      ...
      <p>9.1a Personensuche — vollständig lokale Verarbeitung, keine Auftragsverarbeitung</p>
      <p>Für die optionale Personensuche gelten die vorstehenden Auftragsverarbeitungsbedingungen nicht: AJ GmbH verarbeitet dabei keine Foto- oder biometrischen Inhalte, weil Referenzfoto, daraus abgeleitete Gesichtsmerkmale, die durchsuchten Fotos und das Ergebnis dein Gerät nie verlassen. Wir stellen dafür ausschließlich die technische Software (Erkennungs- und Vergleichsmodell) bereit; die konkrete Verarbeitung führst allein du auf deinem eigenen Gerät durch.</p>
      <p>Soweit du die Personensuche im Rahmen persönlicher oder familiärer Tätigkeiten nutzt, ist regelmäßig allein deine eigene Verarbeitung betroffen und fällt unter die Haushaltsausnahme des Art. 2 Abs. 2 Buchst. c DSGVO (Einzelheiten Abschnitt 4.3 der Datenschutzerklärung). Du bist deshalb dafür verantwortlich, dass du zur Verwendung jedes Referenzfotos berechtigt bist und die Personensuche nur im privaten, persönlichen oder familiären Bereich einsetzt — die ausdrücklich untersagten Einsatzzwecke stehen in Abschnitt 8.</p>
      <h2>10. Verfügbarkeit, Änderungen und Einstellung</h2>
      <p>Für die allgemeine Erreichbarkeit der Website und die Möglichkeit, einen neuen Analysevorgang zu starten, schulden wir keine bestimmte Verfügbarkeit. Wartung, Sicherheitsmaßnahmen, Störungen von Internet-, Hosting- oder KI-Diensten sowie höhere Gewalt können zu Unterbrechungen führen.</p>
      {/* Reworded 2026-08-15: previously read as if the free tier had no
          performance obligation at all ("für den kostenlosen Tarif schulden
          wir keine bestimmte Verfügbarkeit"), contradicting §§ 2 and 11, which
          promise proper performance of a started run regardless of tier. Now
          distinguishes "can we guarantee the service is reachable / a new run
          can start" (no) from "do we owe completion of a run that has already
          begun" (yes, free or paid) — matching what §§ 2 and 11 already say. */}
      <p>Ist ein Analysevorgang — kostenlos oder kostenpflichtig — vertraglich zustande gekommen, schulden wir dagegen die Durchführung genau dieses Vorgangs nach Maßgabe dieser Bedingungen und der gesetzlichen Vorschriften. Können wir einen kostenpflichtig beauftragten Vorgang aus Gründen, die wir zu vertreten haben, nicht oder nicht vollständig erbringen, entfällt der Zahlungsanspruch; einen bereits gezahlten Betrag erstatten wir. Bei nur teilweiser Erbringung erstatten wir den nicht erbrachten Anteil. Weitergehende gesetzliche Rechte bleiben unberührt.</p>
...
function EnglishBody({ withdrawalUrl }: { withdrawalUrl: string }) {
  return (
    <>
      ...
      <p>We provide the confirmation of the contract in text form on a durable medium: we display it in the flow immediately upon formation of the contract and offer it there for saving. If an email address is held in your account, or you add one later, we send you the same text by email as well; in paid plans we also send the invoice.</p>
      ...
      <p>Optionally, you may find persons known to you in your selected private photos using a reference photo. The person search runs entirely on your device; the reference photo, facial features derived from it and the result are never transmitted to us. The feature is intended exclusively for personal or family purposes. You must be authorised to use each reference photo and confirm this before use.</p>
      ...
      <p>You represent that the photos are selected and transmitted solely for personal or family purposes and that use does not infringe copyright, personality or other third-party rights. Where a reference photo shows another person, you must be authorised to use that photo in a private, personal or family context; details on the purely local processing of the person search are in section 9.1a.</p>
      <p>One unticked confirmation in the reference-photo upload field is sufficient for all reference photos in an analysis job. You are not required to tick a separate box for each person or obtain or upload written evidence. This confirmation is a contractual representation; it is not transmitted to or stored by us. ShortlistBuddy may rely on its accuracy unless there are specific indications of misuse or lack of authority.</p>
      <p>The person search must not be used where you know or should know that the person objects or that you are not authorised to use the photo. A stated refusal must be respected in future analysis jobs.</p>
      ...
      <p>9.1 Supplementary terms for processing photo content</p>
      <p>Subject matter and duration: The selected previews, required metadata and analysis results are processed for a specific job. Processing begins when the job starts and ends after analysis and technically unavoidable short-term retention; any different Google retention is described in the Privacy Policy.</p>
      <p>Nature and purpose: Reduction, transmission and automated quality and subject analysis.</p>
      <p>Data and data subjects: Image content, capture metadata and technical job data relating to users and to family members, friends and other persons shown in the selected private photos.</p>
      <p>Instructions and user obligations: You give documented instructions by selecting the photos, setting criteria and starting the analysis. You must not give unlawful instructions.</p>
      ...
      <p>9.1a Person search — purely local processing, no data-processing arrangement</p>
      <p>The supplementary terms above do not apply to the optional person search: AJ GmbH processes no photo or biometric content in this context, because the reference photo, the facial features derived from it, the photos being searched and the result never leave your device. We only provide the technical software (the recognition and matching model); you alone carry out the actual processing on your own device.</p>
      <p>Where you use the person search in the course of personal or household activities, that is regularly your own processing alone and falls within the household exemption in Article 2(2)(c) GDPR (details in section 4.3 of the Privacy Policy). You are therefore responsible for being authorised to use each reference photo and for using the person search only in a private, personal or family context — the expressly prohibited uses are listed in section 8.</p>
      <h2>10. Availability, changes and discontinuation</h2>
      <p>We do not promise a specific availability level for the general reachability of the website or the ability to start a new analysis job. Maintenance, security measures, failures of internet, hosting or AI services, and force majeure may cause interruptions.</p>
      <p>Once an analysis job — free or paid — has come into being, we owe performance of precisely that job in accordance with these terms and the applicable statutory provisions. If we cannot perform a paid job, or cannot perform it fully, for reasons attributable to us, the payment claim lapses and we refund any amount already paid. Where performance is only partial, we refund the portion not performed. Further statutory rights remain unaffected.</p>
