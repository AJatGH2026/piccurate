...
function EnglishBody({ withdrawalUrl }: { withdrawalUrl: string }) {
  return (
    <>
      ...
      <p>In the free plan, a contract for the individual analysis job is formed when you accept these Terms and start the analysis. The free plan also requires an account with a confirmed email address: without an address we could not send you the confirmation of the contract under section 4.2.</p>
