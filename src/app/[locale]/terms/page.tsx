...
function GermanBody() {
  return (
    <>
      ...
      <p>AuswahlBuddy wird derzeit als <strong>kostenlose Beta-Version</strong> bereitgestellt. Der Dienst befindet sich in der Erprobung, kann sich jederzeit ändern, zeitweise nicht verfügbar sein oder Fehler enthalten. Ein Anspruch auf Verfügbarkeit, bestimmte Funktionen oder Ergebnisse besteht nicht.</p>

      <h2>2. Leistungsbeschreibung</h2>
      <p>AuswahlBuddy ist ein KI-gestützter Dienst zur Vorauswahl von Reisefotos. Nutzer laden Fotos hoch (oder importieren aus verbundenen Cloud-Speichern); der Dienst analysiert sie und schlägt anhand konfigurierbarer Kriterien eine Auswahl vor, die im Anschluss geprüft und heruntergeladen werden kann.</p>
      ...
      <p>Du verpflichtest dich, keine rechtswidrigen Inhalte, Schadsoftware oder Inhalte hochzuladen, die Rechte Dritter verletzen. AuswahlBuddy ist für persönliche Reisefotos bestimmt. Wir dürfen den Zugang bei missbräuchlicher Nutzung einschränken oder sperren.</p>
...
function EnglishBody() {
  return (
    <>
      ...
      <p>ShortlistBuddy is currently provided as a <strong>free beta</strong>. The service is under test, may change at any time, be temporarily unavailable, or contain errors. There is no entitlement to availability, specific features, or particular results.</p>

      <h2>2. Service description</h2>
      <p>ShortlistBuddy is an AI-assisted service for pre-selecting travel photos. Users upload photos (or import from connected cloud storage); the service analyses them and proposes a selection based on configurable criteria, which you can then review and download.</p>
      ...
      <p>You agree not to upload illegal content, malware, or content that violates third-party rights. ShortlistBuddy is intended for personal travel photos. We may restrict or suspend access in cases of misuse.</p>
