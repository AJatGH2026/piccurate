...
function GermanBody() {
  return (
    <>
      ...
      <p>Sollte der KI-Anbieter seine Bedingungen so ändern, dass die in Abschnitt 5 beschriebenen Zusagen für diese Inhalte nicht mehr gelten, stellen wir die Personenfunktion ein, bevor die Änderung wirksam wird. Wegen der besonderen Kategorie dieser Daten setzen wir sie in diesem Fall nicht unter geänderten Bedingungen fort.</p>
      <p>Ob und in welchem Umfang die Personenfunktion verfügbar ist, richtet sich nach den Nutzungsbedingungen. Auf die in diesem Abschnitt beschriebene Verarbeitung und die dort zugesagten Schutzmaßnahmen hat das keinen Einfluss.</p>
...
function EnglishBody() {
  return (
    <>
      ...
      <p>Should the AI provider change its terms such that the commitments described in section 5 no longer apply to this content, we will discontinue the Persons feature before the change takes effect. Because of the special category of this data, we will not continue it under changed terms.</p>
      <p>Whether and to what extent the Persons feature is available is governed by the Terms of Use. This has no effect on the processing described in this section or on the safeguards committed to here.</p>
